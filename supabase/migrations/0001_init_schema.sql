...
CREATE TABLE IF NOT EXISTS public.collection_points (
  ...
  contenedor_papel BOOLEAN NOT NULL DEFAULT false,
  contenedor_carton BOOLEAN NOT NULL DEFAULT false,
  contenedor_plastico BOOLEAN NOT NULL DEFAULT false,
  contenedor_vidrio BOOLEAN NOT NULL DEFAULT false,
  contenedor_metales BOOLEAN NOT NULL DEFAULT false,
  contenedor_aceite BOOLEAN NOT NULL DEFAULT false,
  contenedor_pilas_y_accesorios BOOLEAN NOT NULL DEFAULT false,
  contenedor_electrodomesticos_medianos BOOLEAN NOT NULL DEFAULT false,
  contenedor_medicinas BOOLEAN NOT NULL DEFAULT false,
  contact_phone TEXT,
  opening_hours TEXT,
